...
const UpdateAvatar = React.memo(({ onClose }) => {
  ...
  // console.log(typeof newPreview);
  // console.log(newPreview);
  
  const handleUploadImage = (event) => {
    dispatch<any>(updateAvatar({ preview: newPreview, currentUserId })).catch((err) => {});
  };

  const handleUploadImageOld = (event) => {
    ...
    <>
      ...
      <AvatarContainer>
        <Avatar
          ...
          src={src}
        />
        <Box><img src={preview} alt="" /></Box>
      </AvatarContainer>
      <ButtonsContainer>
        <UploadButton onChange={handleUploadImageOld} />
