...
import { getUpdatePresentationOpenState, setUpdatePresentationOpenState } from "../../../../store/presentation/update-presentation.store";
...
const PresentationUpdateDialog = React.memo(() => {
  ...
  const isOpenUpdatePresentation = useSelector(getUpdatePresentationOpenState());
