...
import meetingTypesService from "../../services/meeting/meeting-type.service";
...
const { meetingTypesRequested, meetingTypesReceived, meetingTypesFailed } =
  actions;
...
export const getMeetingTypesStatus = () => (state) =>
  state.meetingTypes.isLoading;
